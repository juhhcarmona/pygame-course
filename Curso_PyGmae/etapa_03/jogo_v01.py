...
class Jogo:
    ...
    def criar_atores(self):
        ...
        self.paola = Ator()
        self.paola.inserir_pose("paola_ED_01.png")
        self.paola.inserir_pose("paola_ED_02.png")
        self.paola.inserir_pose("paola_ED_03.png")
        self.paola.inserir_pose("paola_ED_04.png")
        self.paola.rect.x = 0
